    ...
    <Layout>
        ...
        <div className="container">
          <div className="row">
            <div className="col-12 col-md-6 d-flex flex-column align-items-start justify-content-center text-white">
              ...
              <h1 className="h3 pb-3 text-white">Muestrale a los clientes tus servicios o productos por internet, con tú propio sitio web.</h1>
      ...
      <section className="container text-muted">
        ...
        <ul className="d-flex mt-2 mb-2">
          ...
          <li className="btn text-dark disabled">Página web</li>
        </ul>
      </section>
