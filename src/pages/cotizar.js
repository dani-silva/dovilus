        ...
        <div className="container-lg">
          <div className="row">
            <div className="col-12 col-md-5 mb-5">
              <small className="tag text-muted mb-3">Contactanos directamente</small>
              {/* <h1 className="h2">¿Te interesa un projecto con dovlius?</h1> */}
              <p className="h4 text-dark mb-5">info@dovlius.com</p>
              {/* <p className="h4 text-dark mb-5">646 160 8807</p> */}
  
              <small className="text-muted tag mb-3">Siguenos en redes sociales:</small>
              <ul className="mb-5">
