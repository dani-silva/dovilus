  ...
  return(
    ...
    <Layout>
      ...
      <section className="px-4 px-md-3 container-lg py-5 my-5">
        <div className="row">
            <div className="col-lg-7 col-md-7 col-sm-12 d-flex flex-column justify-content-center align-items-start">
              {/* <h6 className="tag">Ecommerce</h6> */}
              <h1 className="text-primary pb-3">Creamos soluciones digitales para emprendedores.</h1>
            ...
            <div className="py-3 col-lg-5 col-md-5 col-sm-12 d-flex flex-column justify-content-center">
              <Img fluid={data.home.childImageSharp.fluid} className="w-100 h-100" alt="Siempre abierto" />
            </div>
        </div>
      </section>
      ...
      <section className="my-5 py-5 container-lg">
        <div className="row">
          ...
          <div className="col-12 col-md-9">
            ...
            <h1 className="h2 mb-4">Sabemos lo complicado que puede ser, para que tu te enfoques en tus metas comerciales, nosotros estamos aqui para ayudarte con: </h1>
            {/* <p className="mb-5">
...
{/* 
      ...
      <section className="container-lg bg-primary my-5 py-5 rounded-20">
        <div className="py-5 d-flex flex-column align-items-center text-white">
          <span className="tag">Nuestro propósito</span>
          <h2 className="pb-4 text-center text-light">Ayudar a los dueños de negocio a crecer en internet</h2>
          <p className="text-center w-75">Nuestro proposito es ayudar a las empresas a crecer en internet de manera rapida y segura, con herramientas tecnologicas de vanguardia y donde ellas seas las protagonista.</p>
      ...
      <section className="container-lg py-5 mt-5">
        <div className="row">
          ...
          <div className="col-12 col-md-5">
            ...
            <Img fluid={data.contact.childImageSharp.fluid} className="w-100" alt="Siempre abierto" />
